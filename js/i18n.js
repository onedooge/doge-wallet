...
const I18N = {
  zh: {
    ...
    send_to_label: '收款地址',
    idstrip_unnamed: '未取名 · 点这里去 .doge 取名',
    idstrip_id_copied: 'Doge 号已复制 🐕',
    send_to_ph: '地址 / Doge号 / name.doge',
    send_resolve_none: '⚠️ 无法识别(地址/Doge号/.doge),或本地查不到该号',
    toast_resolve_fail: '⚠️ 收款方无法识别,或该 Doge 号本地查不到(需联网)',
  ...
  en: {
    ...
    idstrip_unnamed: 'Unnamed · tap to set in .doge',
    idstrip_id_copied: 'Doge ID copied 🐕',
    send_to_ph: 'address / Doge ID / name.doge',
    send_resolve_none: '⚠️ Unrecognized (address/Doge ID/.doge), or ID not found locally',
    toast_resolve_fail: '⚠️ Cannot resolve recipient, or this Doge ID is not known locally (needs network)',
